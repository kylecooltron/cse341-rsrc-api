...
const resourceValidate = [
    ...
    check('contributing_students', 'Must be an array of user profile_id values').isArray(),
    check('contributing_students.*').trim().escape(),
    // featured languages
    check('featured_technologies', 'Must be an array of featured_technology objects').isArray(),
